...
library(knitr) # for creating the results table
...
results <- data.frame(
  Model = c("Logistic", "LDA", "QDA", "Random Forest"),
  Accuracy = c(0.93, 0.92, 0.83, 0.94),
  Specificity = c(0.11, 0.26, 0.52, 0.23)
)
results_table <- kable(results)
